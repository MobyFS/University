...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Size = System::Drawing::Size(138, 62);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Задача 1";
			...
			this->button2->Location = System::Drawing::Point(156, 29);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(138, 62);
			this->button2->TabIndex = 1;
			this->button2->Text = L"Задача 2";
			...
			this->ClientSize = System::Drawing::Size(304, 114);
